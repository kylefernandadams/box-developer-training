...
class SecurityClassificationExercise {
    ...
    runExercise4_3() {
        return new Promise((resolve, reject) => {
            ...
            client.folders.create('0', `Exercise-4.3-Dev-Training-${currentDateTime}`)
            ...
            .then(fileUploadRes => {
                ...
                return client.files.addMetadata(fileId, client.metadata.scopes.ENTERPRISE, appConfig.classifciationTemplateKey, appConfig.classificationMetadata);
            })
            .then(addMetadataRes => {
            ...
            .catch(err => {
                console.log('Failed to create security classification: ', err);
                reject(err);
            });
        });
    }
...
module.exports = new SecurityClassificationExercise();
